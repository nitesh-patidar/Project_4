      ...
      <%} %>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                    <input type="text" name="email"  placeholder="Enter EmailId" value="<%=DataUtility.getStringData(bean.getEmail())%>" <%--  <%=(bean.getId() > 0) ? "readonly" : ""%> --%>>
                    </td>
                    <td style="position: fixed;">     
              ...
              <tr>
               <td>Course Name<font style="color:red">*</font></td>
                 <td>
                  ...
                  <%=HTMLUtility.getList("courseId",String.valueOf(bean.getCourseId()),l2) %>
                </td>
                <td style="position: fixed;"> 
             ...
             <tr>
               <td>Subject Name<font style="color:red">*</font></td>
                 <td>
                  ...
                  <%=HTMLUtility.getList("subjectId",String.valueOf(bean.getSubjectId()),l3) %>
                </td>
                <td style="position: fixed;"> 
