 ...
 public List<MarksheetBean> getMeritList(int pageNo, int pageSize) throws ApplicationException 
    {
        ...
        StringBuffer sql = new StringBuffer("Select ID ,ROLL_NO ,NAME ,Physics , Chemistry ,Maths,(Physics+Maths+Chemistry) as Total from ST_MARKSHEET where "
        		+ " not(Physics<33 or Chemistry<33 or Maths<33) order by total desc");
