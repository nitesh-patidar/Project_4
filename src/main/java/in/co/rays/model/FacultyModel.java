	           ...
	           
	    {
	        ...
	        try {
	          ...
	          /*  System.out.println(pk + " in ModelJDBC");*/
	            ...
	            pstmt.setString(12, collegeName);
...
public void update(FacultyBean bean) throws ApplicationException,DuplicateRecordException
	    {
	        ...
	        try {
	            conn = JDBCDataSource.getConnection();
	            conn.setAutoCommit(false); 
	            PreparedStatement pstmt = conn.prepareStatement("UPDATE ST_FACULTY SET COLLEGE_ID=?,SUBJECT_ID=?,COURSE_ID=?,FIRST_NAME=?,LAST_NAME=?"
	            		                                          + ",GENDER=?,DOB=?,EMAIL_ID=?,MOBILE_NO=?, COURSE_NAME=?,COLLEGE_NAME=?,SUBJECT_NAME=?"
